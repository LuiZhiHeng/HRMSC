<?php
    if( isset($_POST['id']) &&
        ...
        if($msg == 1){
            $sql = "INSERT INTO leave_request VALUES (NULL, '$emId', '$type', '$reason', '$start', '$end', NULL, '$datetimeNow', NULL, NULL, 3)";
...
// # end file checking            
        ...
        //             $rs = $conn->query($sql);
        //             if($rs) echo '<script>swal("Apply Leave Successfully", "", "success");</script>';
        //             else echo '<script>swal("Apply Leave Failed", "", "error");</script>';
